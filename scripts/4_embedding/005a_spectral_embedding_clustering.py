...
for burst_extraction_params in burst_extraction_params_list:
    try:
        ...
        cv_params = None  # "cv"  # set to None if not using cross-validation or to specific cv_params  # noqa: E501
                    ...
                    try:
                        ...
                        if i_split is not None:
                            burst_matrix = burst_matrix[
                                load_df_bursts(
                                    burst_extraction_params, cv_params=cv_params
